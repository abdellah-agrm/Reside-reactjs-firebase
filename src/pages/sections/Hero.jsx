...
import Logged from "../../elements/Logged";

export default function Hero() {
  return (
    <div className="h-screen lg:flex" id="hero">
      <div className="ml-auto lg:w-9/12 xl:w-7/12">
        <header className="relative mx-auto flex max-w-screen-md flex-col overflow-hidden px-4 py-4 text-gray-900 md:flex-row md:items-center lg:mr-0">
          <a href="/" className="flex cursor-pointer items-center whitespace-nowrap text-3xl font-black">
            <span className="mr-2 text-green-500">
              <HomeIcon className="h-8 w-auto mb-1.5" />
            </span>
            Reside
          </a>
          ...
          <nav aria-label="Header Navigation" className="flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all peer-checked:mt-8 peer-checked:max-h-56 md:ml-24 md:max-h-full md:flex-row md:items-start">
            <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
              <li className="font-bold md:mr-12"><a href="#about">À propos</a></li>
              <li className="font-bold md:mr-12"><a href="#property">Propriétés</a></li>
              <li className="font-bold md:mr-12"><a href="#footer">Contact</a></li>
              <Logged/>
            </ul>
          </nav>
        </header>

        <div className="mb-20 mt-20 px-4 sm:max-w-xl md:max-w-full md:px-24 lg:ml-auto lg:max-w-screen-md lg:px-8">
          <div className="flex flex-col items-center justify-between lg:flex-row">
            <div className="max-w-xl text-center lg:max-w-lg lg:pr-5 lg:text-left">
              <h2 className="mb-6 max-w-lg text-3xl leading-snug tracking-tight text-green-600 sm:text-5xl sm:leading-snug">
                <span className="my-1 inline-block font-serif font-bold text-green-600">Trouver un bien immobilier</span> sans commission
              </h2>
              <p className="text-base text-gray-700">
              les annonces immobilières. Reside est site immobilier à proposer des annonces de location et de vente immobilières. Vous trouverez sur Reside de nombreuses annonces.
              </p>
              <div className="mt-8 flex flex-col justify-center sm:flex-row sm:items-center sm:space-x-4 lg:justify-start">
                <a href="/properties" className="relative mt-4 rounded-lg border-2 border-green-600 bg-green-600 px-6 py-2 font-medium text-white transition hover:translate-y-1">
                ...
                <a href="#property" className="mt-4 flex items-center justify-center rounded-lg px-6 py-2 font-medium text-green-600 transition hover:translate-y-1 hover:bg-white">
      ...
      <div className="relative my-auto hidden h-full bg-green-50 text-green-600 lg:block lg:w-3/12 xl:w-5/12">
        <img className="h-full w-full object-cover" src={HeroBanner} alt="" />
      </div>
    </div>
